...
function ExperienceCard({ date, title, company, href, intro, bullets, tags }: typeof EXPERIENCE[0]) {
  ...
  return (
    <div
      className="grid gap-6 p-5 rounded-xl transition-all duration-200 cursor-default"
      style={{
    ...
    >
      <div
        className="font-mono text-[10px] text-right pt-0.5 leading-relaxed whitespace-nowrap"
      ...
      <div>
        ...
        <ul className="space-y-2 mb-3">
          {bullets.map((bullet, i) => (
            <li
              key={i}
              className="text-[14px] leading-[1.7] pl-3 relative"
